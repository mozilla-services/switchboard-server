...
class Experiment {
    ...
    load(experiments_string) {
        if ('undefined' === typeof experiments_string) {
            throw new Error('experiments_string is undefined')
        }

        let experiments = JSON.parse(experiments_string);
        let results = {};
        ...
        experimentsLoop: for (let experiment in experiments) {
            if (experiments.hasOwnProperty(experiment)) {
                ...
                if (typeof experiments[experiment].match != 'undefined' && Object.keys(experiment.match).length > 1) {
                ...
                if (typeof experiments[experiment].buckets != 'undefined' &&
                    typeof experiments[experiment].buckets.min != 'undefined' &&
                    typeof experiments[experiment].buckets.max != 'undefined') {
